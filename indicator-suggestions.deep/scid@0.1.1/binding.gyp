  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        '<(project_root)/src/optable.cpp',
        '<(project_root)/src/pbook.cpp',
        '<(project_root)/src/pgnparse.cpp',
        '<(project_root)/src/position.cpp',
        '<(project_root)/src/probe.cpp',
        '<(project_root)/src/recog.cpp',
        '<(project_root)/src/sc_base.cpp',
        '<(project_root)/src/scidbase.cpp',
        '<(project_root)/src/searchindex.cpp',
        '<(project_root)/src/sortcache.cpp',
        '<(project_root)/src/spellchk.cpp',
