...
const SIGNAL_LABELS = {
  ...
  'makes-executable': 'marks a file executable (chmod +x  -  corroborates that a fetched file is run as a binary)',
...
const REVIEW_FOCUS = {
  ...
  'makes-executable': 'confirm what file is marked executable and whether it was fetched from the network  -  a downloaded-then-chmod+x file is run as a binary and should have its source and integrity verified',
