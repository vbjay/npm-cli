...
const INDICATOR_REGISTRY = {
  ...
  //
  // The 'makes-executable' signal is the discriminator: a telemetry POST, a
  // JSON config download, or a docs URL reference never needs to flip the
  // execute bit.  Its presence is strong evidence that a file meant to be run
  // is being activated.
  // -------------------------------------------------------------------------
